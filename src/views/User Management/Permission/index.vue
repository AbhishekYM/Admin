...
const totalUsers = computed(() => store.permissions.length);
...
<Layout>
    <div class="d-flex flex-column gap-2">
        <BBreadcrumb class="p-3 py-2 bg-light">
            ...
            <BBreadcrumbItem href="#general">Permissions</BBreadcrumbItem>
        </BBreadcrumb>
    </div>
    <BCard>
        <BCardHeader>
            <BRow class="align-items-center g-2">
                <BCol lg="3" class="me-auto">
                    <BCardTitle title-tag="h6" class="mb-0">Permissions List</BCardTitle>
                </BCol>
                <BCol xl="2" md="3">
                    <div class="search-box">
                        <input type="text" class="form-control search" placeholder="Search for Permissions" v-model="searchQuery">
                ...
                <BCol md="auto">
                    <div class="hstack gap-2">
                        ...
                        <BButton variant="primary" @click="store.modalShow17 = !store.modalShow17"> Add Permissions </BButton>
                    </div>
                </BCol>
            </BRow>
        </BCardHeader>
        <BModal v-model="store.modalShow17" hide-footer title="Add Permissions" modal-class="fadeInRight" size="xl">
          <BForm>    
          <div class="row q-mb-md">
                <div class="col">
                    <label for="Permissionname" class="form-label">Permissionname <span class="text-danger">*</span></label>
                    <div class="position-relative ">
                        <BFormInput v-model="store.form.title" type="text" class=" text-input" id="username" placeholder="Enter name" required />
                    </div>
                </div>&nbsp;&nbsp;
            </div>
        ...
        <BCardBody class="mt-3">
                ...
                <BTableSimple class="table-centered align-middle table-custom-effect table-nowrap mb-0">
                    <BThead class="table-light">
                        <BTr>
                            ...
                            <BTh scope="col" class="sort cursor-pointer" data-sort="user_name">Permission Name</BTh>
                            <BTh scope="col" class="sort cursor-pointer" data-sort="action">Action</BTh>
                        </BTr>
                    </BThead>
                    <BTbody>
                        <BTr v-for="(permission, index) in filteredPermissions" :key="index">
                            <BTd class="user_id">{{ index + 1 }}</BTd>
                            <BTd class="user_name">{{ permission.title }}</BTd>
                              <BTd>
                                <ul class="d-flex gap-2 list-unstyled mb-0">
                                    ...
                                    <li>
                                        <BButton @click="console.log(permission.id);store.getPermission(permission.id)" class="btn btn-subtle-secondary btn-icon btn-sm">
                                            <i class="ph-pencil"></i>
                                        </BButton>
                                    </li>
                                    <li>
          ...
          <div class="row q-mb-md">
                <div class="col">
                    ...
                    <div class="position-relative ">
                        <BFormInput v-model="store.form.title" type="text" class=" text-input" id="usdfername" placeholder="Enter username" required />
                    </div>
                </div>&nbsp;&nbsp;
            ...
            <div class="modal-footer">
                ...
                <BButton  @click="store.updatePermissions()"  variant="primary">Save Changes</BButton>
            </div>
        </BModal>
            </div>
        </BCardBody>
