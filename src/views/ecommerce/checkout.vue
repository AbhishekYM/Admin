...
<template>
    <Layout>
        ...
        <BRow>
            <BCol xxl="8">
                <BRow>
                    <BCol lg="12">
                        <BAlert v-model="dismissibleAlert" variant="danger" fade="true" dismissible>
                            <i class="bi bi-cart3 align-baseline me-1"></i> Minimum order must be <b>$1800</b>. You need to
                            add more products with total cost of <b>$300</b>
                        </BAlert>
                        <BCard no-body>
                            <BCardHeader>
                                <BCardTitle title-tag="h6" class="mb-0">Personal Information</BCardTitle>
                            </BCardHeader>
                            <BCardBody>
                                <BForm action="#!">
                                    <BRow class="g-3">
                    ...
                    <BCol lg="12">
                        <BCard no-body>
                            <BCardHeader class="d-flex align-items-center">
                                <BCardTitle title-tag="h6" class="flex-grow-1 mb-0">Shipping Information</BCardTitle>
                            </BCardHeader>
                            <BCardBody>
                                ...
                                <BRow class="gy-3">
                                    <BCol lg="4" sm="6">
                                        <div class="form-check card-radio rounded-bottom-0">
                                            ...
                                            <label class="form-check-label" for="shippingAddress01">
                                                <span class="mb-3 fw-semibold d-block text-muted text-uppercase">Home
                                                    Address</span>

                                                <span class="fs-md mb-2 d-block fw-medium">Kiara Corkery</span>
                                                <span class="text-muted fw-normal text-wrap mb-1 d-block">912 Park Ave,
                                                    Ketchikan, Alaska 99901, USA</span>
                                        ...
                                        <div class="d-flex flex-wrap p-2 py-1 rounded-bottom border mt-n1">
                                            <div>
                                                <BLink href="javascript: void(0);" class="d-block text-body p-1 px-2" @click="addAddressModal = !addAddressModal"><i class="ri-pencil-fill text-muted align-bottom me-1"></i>
                                                    Edit</BLink>
                                            </div>
                                            <div>
                                                <BLink href="javascript: void(0);" class="d-block text-body p-1 px-2" @click="removeItemModal = !removeItemModal"><i class="ri-delete-bin-fill text-muted align-bottom me-1"></i>
                                                    Remove</BLink>
                                            </div>
                                        </div>
                                    </BCol>
                                    <BCol lg="4" sm="6">
                                        <div class="form-check card-radio rounded-bottom-0">
                                            ...
                                            <label class="form-check-label" for="shippingAddress02">
                                                <span class="mb-3 fw-semibold d-block text-muted text-uppercase">Office
                                                    Address</span>

                                                <span class="fs-md mb-2 d-block fw-medium">Jarrett Rempel</span>
                                                <span class="text-muted fw-normal text-wrap mb-1 d-block">2566 Hc 1,
                                                    Glennallen, Alaska 99588, USA</span>
                                    ...
                                    <BCol lg="4" sm="6">
                                        <BLink href="#!" class="card bg-light bg-opacity-25 border border-light-subtle shadow-none h-100 text-center">
                                            <BCardBody class="d-flex justify-content-center align-items-center">
                                                <div>
                                                    ...
                                                    <div class="fw-medium fs-md text-primary-emphasis stretched-link" @click="addAddressModal = !addAddressModal">Add Address
                                                    </div>
                                                </div>
                                            </BCardBody>
                                        </BLink>
                    ...
                    <BCol lg="12">
                        <BCard no-body>
                            <BCardHeader class="d-flex align-items-center">
                                <BCardTitle title-tag="h6" class="flex-grow-1 mb-0">Payment Information</BCardTitle>
                                <BButton variant="subtle-info" class="flex-shrink-0" @click="addCardModal = !addCardModal"><i class="bi bi-plus-circle align-baseline me-1"></i> Add
                                    Card</BButton>
                            </BCardHeader>
                            <BCardBody>
                                <BRow>
                                        ...
                                        <div class="form-check card-radio">
                                            ...
                                            <label class="form-check-label bg-primary p-4" for="debitCart01">
                                                ...
                                                <span class="d-flex align-items-center mb-4 pb-4">
                                                    <img src="@/assets/images/mastercard.png" alt="" height="20" />
                                                    <i class="ph-wifi-high ms-auto fs-4 text-white-75"></i>
                                                </span>
                                                <span class="fs-3xl text-white fw-medium mb-2 d-block">9873 6548 9871
                                                    0123</span>
                                                <span class="d-flex align-items-center">
                                                    <span class="fs-xs text-white-75 d-block">Ophelia Steuber</span>
                                                    <span class="fs-xxs text-white-75 d-block ms-auto">Valid
                                                        <b>32</b></span>
                                                </span>
                                            </label>
                                        </div>
                                    ...
                                    <BCol lg="4">
                                        <div class="form-check card-radio">
                                            ...
                                            <label class="form-check-label bg-secondary p-4" for="debitCart02">
                                                ...
                                                <span class="d-flex align-items-center mb-4 pb-4">
                                                    <img src="@/assets/images/visa.png" alt="" height="20" />
                                                    <i class="ph-wifi-high ms-auto fs-4 text-white-75"></i>
                                                </span>
                                                <span class="fs-3xl text-white fw-medium mb-2 d-block">9873 6548 9871
                                                    0123</span>
            ...
            <BCol xxl="4">
                <BRow>
                    <BCol lg="12">
                        <BCard no-body>
                            <BCardHeader>
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <BCardTitle title-tag="h5" class="mb-0">Order Summary</BCardTitle>
                                    </div>
                            ...
                            <BCardBody>
                                <div class="table-responsive mb-0">
                                    <BTableSimple class="table-borderless align-middle mb-0">
                                        <BThead class="table-active text-muted">
                                            <BTr>
                                                <BTh style="width: 90px;" scope="col">Product</BTh>
                                                <BTh scope="col">Product Info</BTh>
                                                <BTh scope="col" class="text-end">Price</BTh>
                                            </BTr>
                                        </BThead>
                                        <BTbody>
                                            <BTr>
                                                ...
                                                <BTd>
                                                    <h5 class="fs-md"><router-link to="/ecommerce/product-details" class="text-dark">Branded T-Shirts</router-link></h5>
                                                    <p class="text-muted fw-medium mb-0">$161.25 x 03</p>
                                                </BTd>
                                                <BTd class="text-end fw-semibold">$483.75</BTd>
                                            </BTr>
                                            <BTr>
                                                <BTd>
                                                    <div class="avatar-md">
                                                        <div class="avatar-title bg-light rounded">
                                                            <img src="@/assets/images/products/img-3.png" alt="" class="avatar-sm" />
                                                        </div>
                                                    </div>
                                                </BTd>
                                                <BTd>
                                                    <h5 class="fs-md"><router-link to="/ecommerce/product-details" class="text-dark">Fossil gen 5E smart watch</router-link></h5>
                                                    <p class="text-muted fw-medium mb-0">$69.60 x 02</p>
                                                </BTd>
                                                <BTd class="text-end fw-semibold">$139.20</BTd>
                                            </BTr>
                                            <BTr>
                                                <BTd>
                                                    <div class="avatar-md">
                                                ...
                                                <BTd>
                                                    <h5 class="fs-md"><router-link to="/ecommerce/product-details" class="text-dark">Olive Printed Men Round Neck</router-link>
                                                    </h5>
                                                    <p class="text-muted fw-medium mb-0">$250.00 x 06</p>
                                                </BTd>
                                                <BTd class="text-end fw-semibold">$1,500.00</BTd>
                                            </BTr>
                                            <BTr>
                                                <BTd>
                                                    <div class="avatar-md">
                                                        <div class="avatar-title bg-light rounded">
                                                            <img src="@/assets/images/products/img-9.png" alt="" class="avatar-sm" />
                                                        </div>
                                                    </div>
                                                </BTd>
                                                <BTd>
                                                    <h5 class="fs-md"><router-link to="/ecommerce/product-details" class="text-dark">Flip-Flops and House Slippers</router-link>
                                                    </h5>
                                                    <p class="text-muted fw-medium mb-0">$150.00 x 01</p>
                                                </BTd>
                                                <BTd class="text-end fw-semibold">$150.00</BTd>
                                            </BTr>
                                            <BTr>
                                                <BTd class="fw-semibold" colspan="2">Sub Total :</BTd>
                                                <BTd class="fw-semibold text-end">$2,272.95</BTd>
                                            </BTr>
                                            <BTr>
                                                <BTd colspan="2">Discount <span class="text-muted">(STEEX30)</span> : </BTd>
                                                <BTd class="text-end">- $681.89</BTd>
                                            </BTr>
                                            <BTr>
                                                <BTd colspan="2">Shipping Charge :</BTd>
                                                <BTd class="text-end">$49.99</BTd>
                                            </BTr>
                                            <BTr>
                                                <BTd colspan="2">Estimated Tax (18%): </BTd>
                                                <BTd class="text-end">$409.13</BTd>
                                            </BTr>
                                            <BTr class="border-top border-dashed">
                                                <BTh colspan="2">Total (USD) :</BTh>
                                                <BTd class="text-end">
                    ...
                    <BCol lg="12">
                        <BCard no-body>
                            <BCardHeader>
                                <BCardTitle title-tag="h5" class="mb-0">Additional Service</BCardTitle>
                            </BCardHeader>
                            <BCardBody class="d-flex form-check form-switch gap-3">
                                <div class="flex-grow-1">
                                    ...
                                    <p class="text-muted mb-0">The primary goal of eco-warriors is creating a better world
                ...
                <div class="text-end">
                    <BButton type="button" @click="confirmOrderModal = !confirmOrderModal" variant="primary" class="me-1">Confirm Order</BButton>
                    <router-link to="/ecommerce/products-grid" class="btn btn-secondary">Continue Shopping</router-link>
                </div>
            </BCol>
        </BRow>
    </Layout>
    ...
    <!--confirm orders-->
    <BModal v-model="confirmOrderModal" hide-footer centered id="confirmOrderModal" class="fade zoomIn">
        ...
        <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
            <BButton type="button" variant="ghost-danger" class="w-sm" @click="confirmOrderModal = false"><i class="bi bi-x-lg align-baseline me-1"></i> Close</BButton>
            <BButton type="button" variant="success" class="btn w-sm">Yes, Confirm Order</BButton>
        </div>
    </BModal>

    <!-- editItemModal -->
    <BModal v-model="addAddressModal" title="Add Address" centered hide-footer id="addAddressModal" class="fade zoomIn">
        <div>
            <div class="mb-3">
        ...
        <div class="text-end">
            <BButton type="button" variant="ghost-danger" class="me-1" @click="addAddressModal = false"><i class="bi bi-x-lg align-baseline me-1"></i> Close</BButton>
            <BButton type="button" variant="primary">Add Address</BButton>
        </div>
    </BModal>

    <!-- removeItemModal -->
    <BModal v-model="removeItemModal" centered hide-footer id="removeItemModal" class="fade zoomIn">
        <div class="mt-2 text-center">
        ...
        <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
            <BButton type="button" variant="light" class="w-sm" @click="removeItemModal">Close</BButton>
            <BButton type="button" variant="danger" class="w-sm">Yes, Delete It!</BButton>
        </div>
    </BModal>

    <!-- Modal -->
    <BModal v-model="addCardModal" class="fade" id="addCardModal" centered hide-footer header-class="px-4" title-class="fs-5" title="Add Card">
        <div class="card-wrapper mb-3"></div>

        <div class="form-container active">
            <BForm action="#!" id="card-form-elem" autocomplete="off">
                <div class="mb-3 mt-4">
                ...
                <BButton variant="secondary" class="w-100" type="submit">Add Card</BButton>
            </BForm>
        </div>
    </BModal>
</template>