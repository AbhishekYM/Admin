        ...
        <BRow>
            <BCol xl="6">
                <BCard no-body>
                    ...
                    <BCardBody>
                        <apexchart class="apex-charts" height="300" dir="ltr" :series="simplePieChart.series" :options="simplePieChart.chartOptions"></apexchart>
                    </BCardBody>
                </BCard>
            </BCol>
            <BCol xl="6">
                <BCard no-body>
                    ...
                    <BCardBody>
                        <apexchart class="apex-charts" height="300" dir="ltr" :series="donutChart.series" :options="donutChart.chartOptions"></apexchart>
                    </BCardBody>
                </BCard>
            </BCol>
        </BRow>
        ...
        <BRow>
            <BCol xl="6">
                <BCard no-body>
                    ...
                    <BCardBody>
                        <apexchart class="apex-charts" height="280" dir="ltr" :series="updatingDonutChart.series" :options="updatingDonutChart.chartOptions"></apexchart>
            ...
            <BCol xl="6">
                <BCard no-body>
                    ...
                    <BCardBody>
                        <apexchart class="apex-charts" height="300" dir="ltr" :series="monochromePieChart.series" :options="monochromePieChart.chartOptions"></apexchart>
                    </BCardBody>
                </BCard>
            </BCol>
        </BRow>
        ...
        <BRow>
            <BCol xl="6">
                <BCard no-body>
                    ...
                    <BCardBody>
                        <apexchart class="apex-charts" height="300" dir="ltr" :series="gradientDonutChart.series" :options="gradientDonutChart.chartOptions"></apexchart>
                    </BCardBody>
                </BCard>
            </BCol>
            <BCol xl="6">
                <BCard no-body>
                    ...
                    <BCardBody>
                        <apexchart class="apex-charts" height="300" dir="ltr" :series="patternDonutChart.series" :options="patternDonutChart.chartOptions"></apexchart>
                    </BCardBody>
                </BCard>
            </BCol>
        </BRow>
        ...
        <BRow>
            <BCol xl="6">
                <BCard no-body>
                    ...
                    <BCardBody>
                        <apexchart class="apex-charts" height="300" dir="ltr" :series="imagePieChart.series" :options="imagePieChart.chartOptions"></apexchart>
                    </BCardBody>
                </BCard>
            </BCol>
        </BRow>
