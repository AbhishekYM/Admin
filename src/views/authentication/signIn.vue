                    ...
                    <div class="p-2 mt-5">
                      <BForm action="/">
                        <div class="mb-3">
                          ...
                          <div class="position-relative">
                            <BFormInput v-model="store.form.email" type="text" class="form-control password-input" id="username" placeholder="Enter username" required />
                          </div>
                        </div>

                        <div class="mb-3">
                          <div class="float-end">
                            <router-link to="/auth/pass-reset" class="text-muted">Forgot password?</router-link>
                          </div>
                          <label class="form-label" for="password-input">Password <span class="text-danger">*</span></label>
                          <div class="position-relative auth-pass-inputgroup mb-3">
                            <BFormInput v-model="store.form.password" type="password" class="form-control pe-5 password-input" placeholder="Enter password" id="password-input" required />
                            <BButton variant="link" class="position-absolute end-0 top-0 text-decoration-none text-muted password-addon" id="password-addon"><i class="ri-eye-fill align-middle"></i></BButton>
                          </div>
                        </div>
                        ...
                        <div class="mt-4">
                          <BButton variant="primary" @click="store.handleSubmit" class="w-100" type="submit">Sign In</BButton>
                        </div>
                        ...
                        <div class="mt-4 pt-2 text-center">
                          ...
                          <div class="pt-2 hstack gap-2 justify-content-center">
                            <BButton variant="subtle-primary" class="btn-icon"><i class="ri-facebook-fill fs-lg"></i></BButton>
                            <BButton variant="subtle-danger" class="btn-icon"><i class="ri-google-fill fs-lg"></i></BButton>
                            <BButton variant="subtle-dark" class="btn-icon"><i class="ri-github-fill fs-lg"></i></BButton>
                            <BButton variant="subtle-info" class="btn-icon"><i class="ri-twitter-fill fs-lg"></i></BButton>
                          </div>
                        </div>
                      </BForm>
                      ...
                      <div class="text-center mt-5">
                        <p class="mb-0">
                          ...
                          <router-link to="/auth/signup" class="fw-semibold text-secondary text-decoration-underline">
                            SignUp</router-link>
                        </p>
                      </div>
                    </div>
