        ...
        <BRow class="justify-content-center mt-4">
            <BCol lg="5">
                <div class="text-center mb-5">
                    ...
                    <p class="text-muted mb-4 fs-base">Simple pricing. No hidden fees. Advanced features for you business.
                    </p>
                </div>
            </BCol>
        </BRow>
                    ...
                    <BCol xxl="4" lg="6" class="g-3">
                        <BCard no-body class="pricing-box">
                            <BCardBody class="p-4">
                                ...
                                <div class="mb-4">
                                    <h3 class="mb-0 me-2">$29.99 <small class="fw-normal text-muted fs-xs">/Monthly</small>
                                    </h3>
                                </div>
                    ...
                    <BCol xxl="4" lg="6" class="g-3">
                        <BCard no-body class="pricing-box ribbon-box right">
                            ...
                            <BCardBody class="p-4">
                                ...
                                <div class="mb-4">
                                    <h3 class="mb-0 me-2">$49.99 <small class="fw-normal text-muted fs-xs">/Monthly</small>
                                    </h3>
                                </div>
                                <div class="mt-4">
                                    <ul class="ps-3 vstack gap-3">
                                ...
                                <div class="mt-4">
                                    <BButton variant="secondary" class="disabled w-100">Your Current Plan</BButton>
                                </div>
                            </BCardBody>
                        </BCard>
                    </BCol>
            ...
            <BCol xxl="3" lg="6">
                <BCard no-body class="card-animate border-0 border-top border-2 border-success rounded-0 rounded-bottom">
                    <BCardBody class="m-2 p-4">
                        ...
                        <div class="mt-3 pt-2">
                            <BLink href="#" class="btn btn-danger disabled w-100">Your Current Plan</BLink>
                        </div>
                    </BCardBody>
                </BCard>
            </BCol>
            ...
            <BCol xxl="3" lg="6">
                <BCard no-body class="card-animate border-0 border-top border-2 border-secondary rounded-0 rounded-bottom">
                    <BCardBody class="m-2 p-4">
                        ...
                        <p class="text-muted">Excellent for scaling teams to build culture. Special plan for professional
                            business.</p>
                        <ul class="list-unstyled vstack gap-3">
                            <li>
                                <div class="d-flex">
                    ...
                    <BRow class="g-0">
                        ...
                        <BCol lg="7">
                            <BCardBody class="h-100">
                                ...
                                <BButton type="button" variant="success" class="w-100">Buy Now</BButton>
                            </BCardBody>
                        </BCol>
                    </BRow>
                </BCard>
                    ...
                    <BRow class="g-0">
                        ...
                        <BCol lg="7">
                            <BCardBody class="h-100">
                                ...
                                <BButton type="button" variant="primary" class="w-100">Buy Now</BButton>
                            </BCardBody>
                        </BCol>
                    </BRow>
                </BCard>
                    ...
                    <BRow class="g-0">
                        ...
                        <BCol lg="7">
                            <BCardBody class="h-100">
                                ...
                                <BButton type="button" variant="secondary" class="w-100">Buy Now</BButton>
                            </BCardBody>
                        </BCol>
                    </BRow>
                </BCard>
