                                    ...
                                    <BCardBody class="py-5 d-flex justify-content-between flex-column h-100">
                                        ...
                                        <div class="text-center">
                                            <p class="text-white opacity-75 mb-0 mt-3">
                                                &copy; {{ new Date().getFullYear() }}Steex. Crafted with <i class="mdi mdi-heart text-danger"></i> by Themesbrand
                                            </p>
                                        </div>
                                    </BCardBody>
                                </BCard>
                                ...
                                <BCard no-body class="mb-0 border-0 shadow-none mb-0">
                                    <BCardBody class="p-sm-5 m-lg-4">
                                        <div class="text-center">
                                            ...
                                            <div class="mt-4 pt-3">
                                                <router-link to="/" class="btn btn-primary"><i class="mdi mdi-home me-1"></i> Back to Home</router-link>
                                            </div>
                                        </div>
                                    </BCardBody>
                                </BCard>
